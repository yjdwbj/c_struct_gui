...
DIAVAR int find_paper(const gchar* name);
DIAVAR int get_default_paper(void);
DIAVAR void get_paper_info(PaperInfo *paper, int i, NewDiagramData *data);

DIAVAR GList *get_paper_name_list(void);
DIAVAR const gchar *get_paper_name(int i);
DIAVAR gdouble get_paper_psheight(int i);
DIAVAR gdouble get_paper_pswidth(int i);
DIAVAR gdouble get_paper_lmargin(int i);
DIAVAR gdouble get_paper_rmargin(int i);
DIAVAR gdouble get_paper_bmargin(int i);
DIAVAR gdouble get_paper_tmargin(int i);

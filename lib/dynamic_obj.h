...
DIAVAR void dynobj_list_add_object(DiaObject *obj, guint timeout);
...
*/
DIAVAR void dynobj_list_remove_object(DiaObject *obj);
...
*/
extern __declspec(dllexport) void dynobj_list_foreach(ObjectDynobjFunc orf, gpointer data);
...
/* Returns the dynobj rate collectively resulting from the dynamic objects'
   ...
   to have a timer" */
extern __declspec(dllexport) guint dynobj_list_get_dynobj_rate(void);

...
DIAVAR void element_update_handles(Element *elem);
DIAVAR void element_update_connections_rectangle(Element *elem,
					  ConnectionPoint* cps);
DIAVAR void element_update_boundingbox(Element *elem);
DIAVAR void element_init(Element *elem, int num_handles, int num_connections);
DIAVAR void element_destroy(Element *elem);
DIAVAR void element_copy(Element *from, Element *to);
DIAVAR ObjectChange* element_move_handle(Element *elem, HandleId id,
...
DIAVAR void element_save(Element *elem, ObjectNode obj_node);
DIAVAR void element_load(Element *elem, ObjectNode obj_node);

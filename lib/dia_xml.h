...
DIAVAR AttributeNode composite_find_attribute(DataNode composite_node,
				       const char *attrname);
DIAVAR int attribute_num_data(AttributeNode attribute);
DIAVAR DataNode attribute_first_data(AttributeNode attribute);
DIAVAR DataNode data_next(DataNode data);
DataType data_type(DataNode data);
DIAVAR int data_int(DataNode data);
DIAVAR int data_enum(DataNode data);
DIAVAR real data_real(DataNode data);
DIAVAR int data_boolean(DataNode data);
DIAVAR void data_color(DataNode data, Color *col);
DIAVAR void data_point(DataNode data, Point *point);
DIAVAR void data_bezpoint(DataNode data, BezPoint *point);
void data_rectangle(DataNode data, Rectangle *rect);
DIAVAR char *data_string(DataNode data);
DIAVAR char *data_filename(DataNode data);
...
DIAVAR void data_add_enum(AttributeNode attr, int data);
DIAVAR void data_add_real(AttributeNode attr, real data);
DIAVAR void data_add_boolean(AttributeNode attr, int data);
DIAVAR void data_add_color(AttributeNode attr, const Color *col);
DIAVAR void data_add_point(AttributeNode attr, const Point *point);
DIAVAR void data_add_bezpoint(AttributeNode attr, const BezPoint *point);
void data_add_rectangle(AttributeNode attr, const Rectangle *rect);
DIAVAR void data_add_string(AttributeNode attr, const char *str);
DIAVAR void data_add_filename(AttributeNode attr, const char *str);
DIAVAR void data_add_font(AttributeNode attr, const DiaFont *font);
DIAVAR DataNode data_add_composite(AttributeNode attr,

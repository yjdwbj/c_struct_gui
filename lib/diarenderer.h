...
extern __declspec(dllexport) GType dia_renderer_get_type (void) G_GNUC_CONST;
...
extern __declspec(dllexport) GType dia_interactive_renderer_interface_get_type (void) G_GNUC_CONST;

DIAVAR void dia_renderer_set_size          (DiaRenderer*, gpointer window, int, int);
DIAVAR int  dia_renderer_get_width_pixels  (DiaRenderer*);
DIAVAR int  dia_renderer_get_height_pixels (DiaRenderer*);

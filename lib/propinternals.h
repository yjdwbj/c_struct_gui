...
DIAVAR Property *find_prop_by_name(const GPtrArray *props, const gchar *name);
...
DIAVAR PropDialog *prop_dialog_from_widget(GtkWidget *dialog_widget);
DIAVAR void prop_dialog_destroy(PropDialog *dialog);
DIAVAR void prop_get_data_from_widgets(PropDialog *dialog);
...
DIAVAR void prop_offset_list_calculate_quarks(PropOffset *offsets);

...
DIAVAR void orthconn_update_data(OrthConn *orth);
DIAVAR void orthconn_update_boundingbox(OrthConn *orth);
DIAVAR void orthconn_simple_draw(OrthConn *orth, DiaRenderer *renderer,
			  real width);
DIAVAR void orthconn_init(OrthConn *orth, Point *startpoint);
DIAVAR void orthconn_destroy(OrthConn *orth);
DIAVAR void orthconn_set_points(OrthConn *orth, int num_points, Point *points);
DIAVAR void orthconn_copy(OrthConn *from, OrthConn *to);
DIAVAR void orthconn_save(OrthConn *orth, ObjectNode obj_node);
DIAVAR void orthconn_load(OrthConn *orth, ObjectNode obj_node);  /* NOTE: Does object_init() */
DIAVAR ObjectChange* orthconn_move_handle(OrthConn *orth, Handle *id,
				   Point *to, ConnectionPoint *cp,
				   HandleMoveReason reason,
				   ModifierKeys modifiers);
DIAVAR ObjectChange* orthconn_move(OrthConn *orth, Point *to);
DIAVAR real orthconn_distance_from(OrthConn *orth, Point *point,
			    real line_width);
DIAVAR Handle* orthconn_get_middle_handle(OrthConn *orth);

DIAVAR int orthconn_can_delete_segment(OrthConn *orth, Point *clickedpoint);
DIAVAR int orthconn_can_add_segment(OrthConn *orth, Point *clickedpoint);
DIAVAR ObjectChange *orthconn_delete_segment(OrthConn *orth, Point *clickedpoint);
DIAVAR ObjectChange *orthconn_add_segment(OrthConn *orth, Point *clickedpoint);
DIAVAR ObjectChange *orthconn_toggle_autorouting_callback(DiaObject *orth,
						   Point *clicked,
						   gpointer data);
DIAVAR void orthconn_update_object_menu(OrthConn *orth, Point *clicked,

...
DIAVAR DiaTransform *dia_transform_new (Rectangle *rect, real* zoom);
DIAVAR real dia_transform_length (DiaTransform *transform, real len);
DIAVAR void dia_transform_coords (DiaTransform *transform, coord x, coord y, int *xi, int *yi);
DIAVAR void dia_transform_coords_double (DiaTransform *transform, coord x, coord y, double *xd, double *yd);
DIAVAR real dia_untransform_length(DiaTransform *t, real len);

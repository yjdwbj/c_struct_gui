...
DIAVAR GType dia_line_chooser_get_type (void);
...
DIAVAR void dia_line_chooser_set_line_style(DiaLineChooser *lchooser,
				     LineStyle style,
				     real dashlength);
DIAVAR GtkWidget *dia_line_chooser_new  (DiaChangeLineCallback callback,
				  gpointer user_data);

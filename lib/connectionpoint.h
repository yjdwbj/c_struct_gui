 ...
 */
DIAVAR gint find_slope_directions(Point from, Point to);
 ...
 */
DIAVAR void connpoint_update(ConnectionPoint *p, real x, real y, gint dirs);

DIAVAR gboolean connpoint_is_autogap(ConnectionPoint *cp);

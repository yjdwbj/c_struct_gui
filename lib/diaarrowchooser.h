...
DIAVAR GType dia_arrow_chooser_get_type (void);
...
DIAVAR GtkWidget *dia_arrow_chooser_new (gboolean left,
				  DiaChangeArrowCallback callback,
				  gpointer user_data,
...
DIAVAR void dia_arrow_chooser_set_arrow(DiaArrowChooser *chooser, Arrow *arrow);
DIAVAR ArrowType dia_arrow_chooser_get_arrow_type(DiaArrowChooser *chooser);

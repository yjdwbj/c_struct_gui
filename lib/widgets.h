...
DIAVAR GType    dia_font_selector_get_type        (void);
DIAVAR GtkWidget* dia_font_selector_new             (void);
DIAVAR void       dia_font_selector_set_font        (DiaFontSelector *fs, DiaFont *font);
void       dia_font_selector_set_preview     (DiaFontSelector *fs, gchar *text);
DIAVAR DiaFont *     dia_font_selector_get_font        (DiaFontSelector *fs);
...
DIAVAR GType      dia_alignment_selector_get_type      (void);
DIAVAR GtkWidget* dia_alignment_selector_new           (void);
DIAVAR Alignment  dia_alignment_selector_get_alignment (DiaAlignmentSelector *as);
DIAVAR void       dia_alignment_selector_set_alignment (DiaAlignmentSelector *as,
						 Alignment align);
...
DIAVAR GType      dia_line_style_selector_get_type      (void);
DIAVAR GtkWidget* dia_line_style_selector_new           (void);
DIAVAR void       dia_line_style_selector_get_linestyle (DiaLineStyleSelector *as,
						  LineStyle *linestyle,
						  real *dashlength);
DIAVAR void       dia_line_style_selector_set_linestyle (DiaLineStyleSelector *as,
						  LineStyle linestyle,
						  real dashlength);
...
DIAVAR GType      dia_color_selector_get_type  (void);
DIAVAR GtkWidget* dia_color_selector_new       (void);
DIAVAR void       dia_color_selector_get_color (GtkWidget *cs, Color *color);
DIAVAR void       dia_color_selector_set_color (GtkWidget *cs,
					 const Color *color);
...
DIAVAR GType    dia_arrow_selector_get_type        (void);
DIAVAR GtkWidget* dia_arrow_selector_new           (void);
DIAVAR Arrow      dia_arrow_selector_get_arrow     (DiaArrowSelector *as);
DIAVAR void       dia_arrow_selector_set_arrow     (DiaArrowSelector *as,
					     Arrow arrow);
...
DIAVAR GType      dia_file_selector_get_type        (void);
DIAVAR GtkWidget* dia_file_selector_new             (void);
DIAVAR void       dia_file_selector_set_file        (DiaFileSelector *fs, char *file);
DIAVAR const gchar *dia_file_selector_get_file        (DiaFileSelector *fs);
...
DIAVAR GType      dia_size_selector_get_type        (void);
DIAVAR GtkWidget* dia_size_selector_new             (real width, real height);
DIAVAR void       dia_size_selector_set_locked(DiaSizeSelector *ss, gboolean locked);
DIAVAR void       dia_size_selector_set_size        (DiaSizeSelector *ss, real width, real height);
DIAVAR gboolean   dia_size_selector_get_size        (DiaSizeSelector *ss, real *width, real *height);
...
DIAVAR GType      dia_unit_spinner_get_type  (void);
DIAVAR GtkWidget *dia_unit_spinner_new       (GtkAdjustment *adjustment,
				       DiaUnit adj_unit);
DIAVAR void       dia_unit_spinner_set_value (DiaUnitSpinner *self, gdouble val);
DIAVAR gdouble    dia_unit_spinner_get_value (DiaUnitSpinner *self);
DIAVAR void       dia_unit_spinner_set_upper (DiaUnitSpinner *self, gdouble val);

DIAVAR GList *    get_units_name_list(void);
...
DIAVAR GType      dia_dynamic_menu_get_type  (void);

DIAVAR GtkWidget *dia_dynamic_menu_new(DDMCreateItemFunc create,
				gpointer userdata,
				GtkMenuItem *otheritem, gchar *persist);
DIAVAR GtkWidget *dia_dynamic_menu_new_stringbased(GtkMenuItem *otheritem,
					    gpointer userdata,
					    gchar *persist);
DIAVAR GtkWidget *dia_dynamic_menu_new_listbased(DDMCreateItemFunc create,
					  gpointer userdata,
					  gchar *other_label,
					  GList *items, gchar *persist);
DIAVAR GtkWidget *dia_dynamic_menu_new_stringlistbased(gchar *other_label,
						GList *items,
						gpointer userdata,
						gchar *persist);
DIAVAR void dia_dynamic_menu_add_default_entry(DiaDynamicMenu *ddm, const gchar *entry);
DIAVAR gint dia_dynamic_menu_add_entry(DiaDynamicMenu *ddm, const gchar *entry);
DIAVAR void dia_dynamic_menu_set_sorting_method(DiaDynamicMenu *ddm, DdmSortType sort);
DIAVAR void dia_dynamic_menu_reset(GtkWidget *widget, gpointer userdata);
DIAVAR void dia_dynamic_menu_set_max_entries(DiaDynamicMenu *ddm, gint max);
DIAVAR void dia_dynamic_menu_set_columns(DiaDynamicMenu *ddm, gint cols);
DIAVAR gchar *dia_dynamic_menu_get_entry(DiaDynamicMenu *ddm);
DIAVAR void dia_dynamic_menu_select_entry(DiaDynamicMenu *ddm, const gchar *entry);

 ...
 *
 * structoperation.c : refactored from struct.c, class.c to final use StdProps
...
classType = dia.get_object_type ("STRUCT - Class")
operType  = dia.get_object_type ("STRUCT - Operation")
paramType = dia.get_object_type ("STRUCT - Parameter")
for c in theClasses :
...
extern PropEnumData _struct_inheritances[];

...
static PropEnumData prop_data_define_type[] = {
    {N_("u_int8"),DATA_U8},
    {N_("u_int16"),DATA_U16},
    {N_("u_int32"),DATA_U32},
    {N_("u_int64"),DATA_U64},
    {N_("pointer"),DATA_Point},
    {N_("struct"),DATA_Struct},
    {N_("union"),DATA_Union},
    {N_("enum"),DATA_Enum},
    { NULL, 0 }
};
...
static PropDescription association_props[] = {
  ...
  { "assoc_type", PROP_TYPE_ENUM, PROP_FLAG_VISIBLE|PROP_FLAG_OPTIONAL|PROP_FLAG_NO_DEFAULTS,
   N_("My Type"), NULL, prop_data_define_type },
...
static PropOffset association_offsets[] = {
  ...
  { "custom_color", PROP_TYPE_COLOUR, offsetof(Association, custom_color) },
  { NULL, 0, 0 }
};
